...
* [Kairos](https://github.com/kairos-io/kairos) ⭐ 1,795 | 🐛 281 | 🌐 Go | 📅 2026-08-14 - The immutable Linux meta-distribution for edge Kubernetes.
...
* [Fedora Atomic](https://fedoraproject.org/atomic-desktops/) - The official atomic editons of Fedora
  ...
  * Related Projects
    * [Universal Blue](https://universal-blue.org/) - An organization dedicated to build and distribute cloud-native OSTree OCI images originally based on Fedora Atomic. [list of source images](https://github.com/orgs/ublue-os/packages), [list of end-user images](https://universal-blue.org/#images)
      * [Bazzite](https://github.com/ublue-os/bazzite/) ⭐ 8,939 | 🐛 1,277 | 🌐 Just | 📅 2026-08-16 - A Universal Blue (Fedora Atomic -based) OCI image focused on Gaming (desktop and handheld); the gold standard for Linux Gaming
    ...
    * Community & Downstream OCI Projects - These projects are built using Universal Blue infrastructure or base images and utilize BlueBuild to provide specialized versions of the uBlue stack
      * [SecureBlue](https://github.com/secureblue/secureblue) ⭐ 1,031 | 🐛 149 | 🌐 Python | 📅 2026-08-17 - A security-hardened project that adds kernel hardening, a hardened memory allocator (from GrapheneOS), and reduced attack surfaces to the Fedora Atomic/uBlue base
...
* [NixOS](https://nixos.org/) - a Linux distribution based on Nix package manager
  * [awesome-nix](https://github.com/nix-community/awesome-nix) ⭐ 5,381 | 🐛 23 | 📅 2026-07-23 - An awesome curated knowledge-base about Nix
...
* [Distrobox](https://github.com/89luca89/distrobox) ⭐ 12,864 | 🐛 140 | 🌐 Go | 📅 2026-08-09 - Tool for containerized command line environments on Linux, distribution agnostic, supports a wide variety of containers , works both with podman and docker - This is a great tool to start with on your existing distro to learn working with day-to-day container workflows.
...
* [devbox](https://github.com/jetpack-io/devbox) ⭐ 12,276 | 🐛 493 | 🌐 Go | 📅 2026-08-16 - Devbox is a command-line tool that lets you easily create isolated shells and containers.
* [Toolbx](https://github.com/containers/toolbox) ⭐ 3,462 | 🐛 246 | 🌐 Go | 📅 2026-08-05 - Tool for containerized command line environments on Linux
...
* [podman](https://podman.io/) - Podman is a daemonless container engine for developing, managing, and running OCI Containers on your Linux System.
  ...
  * [Podman Desktop](https://github.com/containers/podman-desktop) ⭐ 7,934 | 🐛 949 | 🌐 TypeScript | 📅 2026-08-16 - Manage different container engines from a single UI and tray icon
...
* [BootC](https://github.com/containers/bootc) ⭐ 2,210 | 🐛 321 | 🌐 Rust | 📅 2026-08-15 - Transactional, in-place operating system updates using OCI/Docker container images.
* [libostree (a.k.a. OSTree)](https://github.com/ostreedev/ostree) ⭐ 1,665 | 🐛 428 | 🌐 C | 📅 2026-08-06 - Operating system and container binary deployment and upgrades
