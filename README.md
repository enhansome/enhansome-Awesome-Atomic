...
* [Kairos](https://github.com/kairos-io/kairos) ⭐ 1,828 | 🐛 459 | 🌐 Go | 📅 2026-09-23 - The immutable Linux meta-distribution for edge Kubernetes.
...
* [Fedora Atomic](https://fedoraproject.org/atomic-desktops/) - The official atomic editons of Fedora
  ...
  * Related Projects
    * [Universal Blue](https://universal-blue.org/) - An organization dedicated to build and distribute cloud-native OSTree OCI images originally based on Fedora Atomic. [list of source images](https://github.com/orgs/ublue-os/packages), [list of end-user images](https://universal-blue.org/#images)
      * [Bazzite](https://github.com/ublue-os/bazzite/) ⭐ 9,109 | 🐛 1,419 | 🌐 Just | 📅 2026-09-23 - A Universal Blue (Fedora Atomic -based) OCI image focused on Gaming (desktop and handheld); the gold standard for Linux Gaming
    ...
    * Community & Downstream OCI Projects - These projects are built using Universal Blue infrastructure or base images and utilize BlueBuild to provide specialized versions of the uBlue stack
      * [SecureBlue](https://github.com/secureblue/secureblue) ⭐ 1,069 | 🐛 168 | 🌐 Python | 📅 2026-09-24 - A security-hardened project that adds kernel hardening, a hardened memory allocator (from GrapheneOS), and reduced attack surfaces to the Fedora Atomic/uBlue base
...
* [NixOS](https://nixos.org/) - a Linux distribution based on Nix package manager
  * [awesome-nix](https://github.com/nix-community/awesome-nix) ⭐ 5,454 | 🐛 24 | 📅 2026-07-23 - An awesome curated knowledge-base about Nix
...
* [Distrobox](https://github.com/89luca89/distrobox) ⭐ 13,004 | 🐛 154 | 🌐 Go | 📅 2026-09-17 - Tool for containerized command line environments on Linux, distribution agnostic, supports a wide variety of containers , works both with podman and docker - This is a great tool to start with on your existing distro to learn working with day-to-day container workflows.
...
* [devbox](https://github.com/jetpack-io/devbox) ⭐ 12,373 | 🐛 415 | 🌐 Go | 📅 2026-09-23 - Devbox is a command-line tool that lets you easily create isolated shells and containers.
* [Toolbx](https://github.com/containers/toolbox) ⭐ 3,506 | 🐛 251 | 🌐 Go | 📅 2026-09-08 - Tool for containerized command line environments on Linux
...
* [podman](https://podman.io/) - Podman is a daemonless container engine for developing, managing, and running OCI Containers on your Linux System.
  ...
  * [Podman Desktop](https://github.com/containers/podman-desktop) ⭐ 8,025 | 🐛 863 | 🌐 TypeScript | 📅 2026-09-24 - Manage different container engines from a single UI and tray icon
  * [Pods](https://github.com/marhkb/pods) ⭐ 1,093 | 🐛 41 | 🌐 Rust | 📅 2026-07-23 - a podman desktop application (formely known as Symfony)
...
* [BootC](https://github.com/containers/bootc) ⭐ 2,287 | 🐛 335 | 🌐 Rust | 📅 2026-09-23 - Transactional, in-place operating system updates using OCI/Docker container images.
