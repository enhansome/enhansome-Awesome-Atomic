...
* [Kairos](https://github.com/kairos-io/kairos) ⭐ 1,821 | 🐛 297 | 🌐 Go | 📅 2026-09-17 - The immutable Linux meta-distribution for edge Kubernetes.
...
* [Fedora Atomic](https://fedoraproject.org/atomic-desktops/) - The official atomic editons of Fedora
  ...
  * Related Projects
    * [Universal Blue](https://universal-blue.org/) - An organization dedicated to build and distribute cloud-native OSTree OCI images originally based on Fedora Atomic. [list of source images](https://github.com/orgs/ublue-os/packages), [list of end-user images](https://universal-blue.org/#images)
      * [Bazzite](https://github.com/ublue-os/bazzite/) ⭐ 9,083 | 🐛 1,424 | 🌐 Just | 📅 2026-09-17 - A Universal Blue (Fedora Atomic -based) OCI image focused on Gaming (desktop and handheld); the gold standard for Linux Gaming
    ...
    * Community & Downstream OCI Projects - These projects are built using Universal Blue infrastructure or base images and utilize BlueBuild to provide specialized versions of the uBlue stack
      * [SecureBlue](https://github.com/secureblue/secureblue) ⭐ 1,064 | 🐛 169 | 🌐 Python | 📅 2026-09-15 - A security-hardened project that adds kernel hardening, a hardened memory allocator (from GrapheneOS), and reduced attack surfaces to the Fedora Atomic/uBlue base
...
* [NixOS](https://nixos.org/) - a Linux distribution based on Nix package manager
  * [awesome-nix](https://github.com/nix-community/awesome-nix) ⭐ 5,447 | 🐛 23 | 📅 2026-07-23 - An awesome curated knowledge-base about Nix
...
* [devbox](https://github.com/jetpack-io/devbox) ⭐ 12,361 | 🐛 414 | 🌐 Go | 📅 2026-09-17 - Devbox is a command-line tool that lets you easily create isolated shells and containers.
* [Toolbx](https://github.com/containers/toolbox) ⭐ 3,499 | 🐛 250 | 🌐 Go | 📅 2026-09-08 - Tool for containerized command line environments on Linux
...
* [apx](https://github.com/Vanilla-OS/apx) ⭐ 590 | 🐛 29 | 🌐 Go | 📅 2026-09-16 - The default package manager for VanillaOS, utilising Distrobox to manage containers for various distros on the user's behalf.
...
* [podman](https://podman.io/) - Podman is a daemonless container engine for developing, managing, and running OCI Containers on your Linux System.
  ...
  * [Podman Desktop](https://github.com/containers/podman-desktop) ⭐ 8,017 | 🐛 870 | 🌐 TypeScript | 📅 2026-09-17 - Manage different container engines from a single UI and tray icon
  * [Pods](https://github.com/marhkb/pods) ⭐ 1,089 | 🐛 40 | 🌐 Rust | 📅 2026-07-23 - a podman desktop application (formely known as Symfony)
...
* [BootC](https://github.com/containers/bootc) ⭐ 2,279 | 🐛 332 | 🌐 Rust | 📅 2026-09-16 - Transactional, in-place operating system updates using OCI/Docker container images.
* [libostree (a.k.a. OSTree)](https://github.com/ostreedev/ostree) ⭐ 1,684 | 🐛 426 | 🌐 C | 📅 2026-09-14 - Operating system and container binary deployment and upgrades
...
* [ABRoot](https://github.com/Vanilla-OS/ABRoot) ⭐ 392 | 🐛 26 | 🌐 Go | 📅 2026-09-16 - A utility which provides full immutability and atomicity to a Linux system, by transacting between two root filesystems. Updates are performed using OCI images, to ensure that the system is always in a consistent state.
* [bootupd](https://github.com/coreos/bootupd) ⭐ 196 | 🐛 55 | 🌐 Rust | 📅 2026-09-16 - Distribution-independent updates for bootloaders.
