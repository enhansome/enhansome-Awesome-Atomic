...
* [NixOS](https://nixos.org/) - a Linux distribution based on Nix package manager
  * [awesome-nix](https://github.com/nix-community/awesome-nix) ⭐ 5,425 | 🐛 22 | 📅 2026-07-23 - An awesome curated knowledge-base about Nix
...
* [BootC](https://github.com/containers/bootc) ⭐ 2,244 | 🐛 327 | 🌐 Rust | 📅 2026-08-29 - Transactional, in-place operating system updates using OCI/Docker container images.
* [libostree (a.k.a. OSTree)](https://github.com/ostreedev/ostree) ⭐ 1,673 | 🐛 424 | 🌐 C | 📅 2026-08-25 - Operating system and container binary deployment and upgrades
